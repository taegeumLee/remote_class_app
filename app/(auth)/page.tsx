    ...
    <div className="flex flex-col items-center  min-h-screen bg-neutral-100 *:text-neutral-900">
      <div className="flex flex-col bg-white justify-between rounded-2xl p-4 w-full max-w-screen-md min-h-screen ">
        ...
        <div className="flex flex-col items-center gap-2 w-full ">
          <button className="py-2.5 text-lg w-full text-neutral-900 bg-neutral-100 rounded-lg p-4 hover:bg-blue-400 hover:text-neutral-100 transition-all">
            구글 로그인
          </button>
          <button className="py-2.5 text-lg w-full my-2 text-neutral-900 bg-neutral-100 rounded-lg p-4 hover:bg-blue-400 hover:text-neutral-100 transition-all">
            이메일 로그인
          </button>
